...
class FlamingoRewardsCfg():
    ...
    base_height = RewTerm(
        ...
        weight=-25.0,
        params={
            "target_height": 0.33,  # Phase 1 fixed base height (matches flat stand_drive)
    ...
    error_track_pos_integral = RewTerm(
        func=mdp.error_track_pos_integral,
        weight=-2.5,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="base_link"),
            "command_name": "integral_position",
            "kernel": "linear",
            "delta": 0.0,
            "scale": 1.0,
...
class FlamingoRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Keep the rough-terrain height map observations, but remove the flat/task-only extras.
        ...
        self.observations.none_stack_policy.left_wheel_height_scan = None
        self.observations.none_stack_policy.right_wheel_height_scan = None
        ...
        # self.observations.none_stack_critic.base_lin_vel_z = None
        # self.observations.none_stack_critic.base_lin_vel_y = None
        # self.observations.none_stack_critic.base_lin_vel_x = None
        # self.observations.none_stack_critic.base_pos_z = None
        # self.observations.none_stack_critic.current_reward = None
        # self.observations.none_stack_critic.is_contact = None
